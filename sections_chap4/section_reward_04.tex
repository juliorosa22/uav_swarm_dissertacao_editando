...
A Figura~\ref{fig:rm_diagram} ilustra de forma resumida os estados da Máquina de Recompensa e as principais condições de transição entre eles. A definição formal das proposições lógicas, da função de transição da RM e da associação completa entre estados e pesos é apresentada no Apêndice~\ref{apendice:rm_isaacsim}. A formulação matemática detalhada da função de recompensa adotada no ambiente IsaacSim, incluindo todos os termos e seus intervalos de valores, é apresentada no Apêndice~\ref{apendice:reward_isaacsim}.
...
Nos apêndices, são apresentadas a definição formal completa da Máquina de Recompensa e a formulação matemática detalhada da função de recompensa adotada no ambiente IsaacSim.
% =========================================================
